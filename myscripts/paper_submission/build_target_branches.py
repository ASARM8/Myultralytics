...
REFERENCES = [
    ...
    "T.-Y. Lin, P. Dollár, R. Girshick, K. He, B. Hariharan, and S. Belongie, ‘Feature pyramid networks for object detection,’ in Proceedings of the IEEE Conference on Computer Vision and Pattern Recognition, 2117–2125 (2017).",
    "K. He, G. Gkioxari, P. Dollár, and R. Girshick, ‘Mask R-CNN,’ in Proceedings of the IEEE International Conference on Computer Vision, 2961–2969 (2017).",
    "G.-S. Xia, X. Bai, J. Ding, et al., ‘DOTA: a large-scale dataset for object detection in aerial images,’ in Proceedings of the IEEE Conference on Computer Vision and Pattern Recognition, 3974–3983 (2018).",
    "X. Yang, X. Yang, J. Yang, et al., ‘Learning high-precision bounding box for rotated object detection via Kullback–Leibler divergence,’ Advances in Neural Information Processing Systems 34, 18381–18394 (2021).",
]
